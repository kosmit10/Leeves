...
struct akcesoria: View {
    ...
    private func loadProducts() {
        ...
        Task {
            do {
                let fetchedProducts = try await fetchProducts(from: "https://leeves.pl/category/shop/akcesoria")
...
struct akcesoria_Previews: PreviewProvider {
